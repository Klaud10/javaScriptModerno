//___FACTORY___Crea objetos basados en ciertas condiciones
...
const inputText2 = elemento2.crearElemento('tel', 'telefonoCliente');
console.log(inputText2.crearInput());

const elemento3 = new HTMLFactory();
const inputText3 = elemento3.crearElemento('email', 'emailCliente');
